...
import static org.apache.hop.core.row.value.ValueMetaBase.convertStringToBoolean;
...
public class ValueMetaBaseTest {
  ...
  @Spy protected DatabaseMeta databaseMetaSpy;

  protected PreparedStatement preparedStatementMock;
  ...
  public void before() throws Exception {
    ...
    databaseMetaSpy = spy(new DatabaseMeta());
    preparedStatementMock = mock(PreparedStatement.class);
    PKG = ValueMetaBase.PKG;
  ...
  public void testConvertStringToBoolean() {
    assertNull(convertStringToBoolean(null));
    assertNull(convertStringToBoolean(""));
    assertTrue(convertStringToBoolean("Y"));
    assertTrue(convertStringToBoolean("y"));
    assertTrue(convertStringToBoolean("Yes"));
    assertTrue(convertStringToBoolean("YES"));
    assertTrue(convertStringToBoolean("yES"));
    assertTrue(convertStringToBoolean("TRUE"));
    assertTrue(convertStringToBoolean("True"));
    assertTrue(convertStringToBoolean("true"));
    assertTrue(convertStringToBoolean("tRuE"));
    assertTrue(convertStringToBoolean("Y"));
    assertFalse(convertStringToBoolean("N"));
    assertFalse(convertStringToBoolean("No"));
    assertFalse(convertStringToBoolean("no"));
    assertFalse(convertStringToBoolean("Yeah"));
    assertFalse(convertStringToBoolean("False"));
    assertFalse(convertStringToBoolean("NOT false"));
  }
  ...
  @Test
  public void testMetdataPreviewSqlVarcharToPentahoString()
  ...
  @Test
  public void testMetdataPreviewSqlNVarcharToPentahoString()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlLongVarcharToPentahoString()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlNClobToPentahoString()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlBigIntToPentahoInteger()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlIntegerToPentahoInteger()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlSmallIntToPentahoInteger()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlTinyIntToPentahoInteger()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlDecimalToPentahoBigNumber()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlDecimalToPentahoInteger()
      throws SQLException, HopDatabaseException {
    doReturn(Types.DECIMAL).when(resultSet).getInt("DATA_TYPE");
  ...
  @Test
  public void testMetdataPreviewSqlDoubleToPentahoNumber()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlDoubleToPentahoBigNumber()
      throws SQLException, HopDatabaseException {
    doReturn(Types.DOUBLE).when(resultSet).getInt("DATA_TYPE");
    doReturn(20).when(resultSet).getInt("COLUMN_SIZE");
    doReturn(mock(Object.class)).when(resultSet).getObject("DECIMAL_DIGITS");
  ...
  @Test
  public void testMetdataPreviewSqlFloatToPentahoNumber()
      throws SQLException, HopDatabaseException {
  ...
  @Test
  public void testMetdataPreviewSqlBooleanToPentahoBoolean()
      throws SQLException, HopDatabaseException {
