 ...
 * @author Matt
 * @since 19-04-2004
 * @cloned for the google sheet plugun by @author JFMONTEIL
 *
 *
 */
public class GoogleSheetsPluginInputFields implements Cloneable, ITextFileInputField {
  ...
  public GoogleSheetsPluginInputFields( String fieldname, int position, int length ) {
    this.name = fieldname;
  ...
  public GoogleSheetsPluginInputFields() {
    this( null, -1, -1 );
  }

  public int compare( Object obj ) {
    GoogleSheetsPluginInputFields field = (GoogleSheetsPluginInputFields) obj;
  ...
  public ITextFileInputField createNewInstance( String newFieldname, int x, int newlength ) {
    return new GoogleSheetsPluginInputFields( newFieldname, x, newlength );
  }
}