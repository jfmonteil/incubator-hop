...
public class GoogleSheetsPluginOutputDialog extends BaseTransformDialog implements ITransformDialog {
    ...
    public GoogleSheetsPluginOutputDialog(Shell parent, IVariables variables,Object in, PipelineMeta pipelineMeta, String name) {
    ...
    public String open() {
        ...
        wlTransformName.setText(BaseMessages.getString(PKG, "GoogleSheetsPluginOutputDialog.Stepname.Label"));
	   ...
	   // privatekey - Text
		...
		wlShareDW.setText( BaseMessages.getString( PKG,"GoogleSheetsPluginOutputDialog.Share.LabelDW" ));
		...
		// Share domainwise with label
		shareDomain = new TextVar( variables,spreadsheetComposite, SWT.SINGLE | SWT.LEFT | SWT.BORDER );
