...
@Transform(
	...
	i18nPackageName = "org.apache.hop.pipeline.transforms.googlesheet.GoogleSheetsPluginOutput",
    name = "GoogleSheetsPluginOutput.transform.Name",
	description = "GoogleSheetsPluginOutput.transform.Name",
	categoryDescription = "i18n:org.apache.hop.pipeline.transform:BaseTransform.Category.Input",
	documentationUrl ="https://github.com/jfmonteil/Pentaho-Google-Sheet-Plugin/blob/master/README.md"
	) 
	
@InjectionSupported( localizationPrefix = "GoogleSheetsPluginOutput.injection.", groups = { "SHEET", "INPUT_FIELDS" } )
public class GoogleSheetsPluginOutputMeta extends BaseTransformMeta implements ITransformMeta <GoogleSheetsPluginOutput, GoogleSheetsPluginOutputData>{ //<Constant, ConstantData>
	
	private static Class<?> PKG = GoogleSheetsPluginOutputMeta.class; // for i18n purposes, needed by Translator2!!   $NON-NLS-1$
  ...
  @Override
  public GoogleSheetsPluginOutput createTransform( TransformMeta transformMeta, GoogleSheetsPluginOutputData iTransformData, int cnr, PipelineMeta pm, Pipeline pipeline ) {
